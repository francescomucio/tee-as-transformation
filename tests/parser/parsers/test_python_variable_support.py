...
'''
        ...
        try:
            ...
            with patch.object(parser, '_execute_function') as mock_execute:
                ...
                result = parser.evaluate_model_function(model_data, "test_schema.test_model", variables)
...
'''
        ...
        try:
            ...
            with patch.object(parser, '_execute_function') as mock_execute:
                ...
                result = parser.evaluate_model_function(model_data, "test_schema.test_nested_model", variables)
