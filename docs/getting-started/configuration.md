...
t4t supports flexible configuration through `pyproject.toml` files and environment variables. This guide covers all configuration options.
...
t4t validates configuration at startup:
