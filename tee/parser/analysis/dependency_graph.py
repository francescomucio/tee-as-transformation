...
class DependencyGraphBuilder:
    ...
    def build_graph(self, parsed_models: Dict[str, ParsedModel], table_resolver) -> DependencyGraph:
        ...
        try:
            ...
            for table_name, model_info in parsed_models.items():
                ...
                if "sqlglot" in model_info and model_info["sqlglot"] and "tables" in model_info["sqlglot"]:
                    for referenced_table in model_info["sqlglot"]["tables"]:
                        ...
                        full_ref_name = table_resolver.resolve_table_reference(referenced_table, parsed_models)
            ...
            execution_order = self._topological_sort_with_graphlib(dependencies) if not cycles else []
